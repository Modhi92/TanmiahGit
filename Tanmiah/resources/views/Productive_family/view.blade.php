                        ...
                        <div class=" filterable">
                            <div class="panel-heading">
                                ...
                                <div class="pull-right">
                                    ...
                                    <a href="createProductive_family" class="btn btn-success btn-xs "><span
                            ...
                            <table class="table">
                                ...
                                @foreach($data as $family)
                                    <tr>
                                        ...
                                        <td>
                                            <form id="delete-form" action="delete/Productive_family/{{$family->id}}" method="POST">
                                                {{ csrf_field() }}
                                                <button class="btn btn-danger btn-xs"
                                                        onclick="return confirm('هل انت متاكد من حذف  - {{$family->name}}?') ">
                                                    <span class=" glyphicon glyphicon-trash "></span>
                                                </button>
                                            </form>
                                        </td>
                                        <td>
                                            <a class="btn btn-info btn-xs" href="editProductive_family/{{$family->id}}"><span
